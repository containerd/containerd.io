...
# 2. copy docs/ directory in each submodule to content/docs/${VERSION}
# 3. copy README to content/docs/${VERSION}/_index.md
...
# move images from static/content/docs/$X_VER/... to static/docs/$X_VER/... so that docs find them where they expect to see them
rm -rf static/docs
